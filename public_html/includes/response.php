...
class Response {
    ...
    public static function logRequest($endpoint, $method, $user_id = null, $status_code = 200) {
        if ((isset($_ENV['APP_DEBUG']) && $_ENV['APP_DEBUG'] === 'true') || 
            ...
            // Log the data (e.g., to a file or database)
            // For this example, we'll just simulate logging by echoing or storing in a variable
            // In a real application, you would implement proper logging here.
            // Example: file_put_contents(sys_get_temp_dir() . '/api_requests.log', json_encode($log_data) . PHP_EOL, FILE_APPEND);
        }
    }
}
